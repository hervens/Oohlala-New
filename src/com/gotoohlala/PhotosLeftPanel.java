...
public class PhotosLeftPanel extends FrameLayout implements CampusWallPostInterface, TabInterface {

	Button bScrollToTop, bPostThread, bStudents;
	...
	TextView tvStudents, headerCampusWall, filterHeader, filterRow1, filterFooter;
	...
	public PhotosLeftPanel(Context context) {
		super(context);
		...
		if (Profile.has_update){
		 ...
		 v = (RelativeLayout) mLayoutInflater.inflate(R.layout.photosleftpanel, null);  
	     addView(v);  
	     ...
	     TopMenuNavbar = (TopMenuNavbar) v.findViewById(R.id.bTopMenuNavBar);
			...
			bPostThread.setOnClickListener(new Button.OnClickListener() {
				public void onClick(View v) {
					// TODO Auto-generated method stub
					CampusWallPostThread.act = PhotosLeftPanel.this;
					Bundle extras = new Bundle();
					extras.putBoolean("is_global", true);
			...
			try {
				...
				mHandler.post(new Runnable() {
	        		public void run() {
						...
						param.addRule(RelativeLayout.BELOW, filterRow1.getId());
